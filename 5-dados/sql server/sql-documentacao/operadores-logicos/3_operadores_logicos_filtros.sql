...
--LIKE Encontra quaisquer valores que tenham "r" na segunda posi o	 
	SELECT a.primeiro_nome,
	       a.ultimo_nome
	 FROMcliente a
		WHERE a.primeiro_nome LIKE '_r%'; 

--LIKE Localiza valores que come am com "a" e possuem pelo menos 3 caracteres de comprimento 
	SELECT a.primeiro_nome,
	       a.ultimo_nome 
    FROMcliente a 
		WHERE a.primeiro_nome LIKE 'A_%_%';

--LIKE Localiza valores que come am com "a" e termina com "o"
	SELECT a.primeiro_nome,
	       a.ultimo_nome 
   FROMcliente a
		WHERE a.primeiro_nome LIKE 'a%o'; 

--LIKE Localiza valores que come am com "a"	 
	SELECT a.primeiro_nome,
	       a.ultimo_nome  
	FROMcliente a
